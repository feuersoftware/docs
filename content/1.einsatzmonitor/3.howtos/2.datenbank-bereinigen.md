...
![Datenbank öffnen](/images/einsatzmonitor/SQLBrowser_DB_open.png)
...
3. Navigieren Sie zu **System** → **Datenbank**
...
1. Öffnen Sie **Einstellungen** → **System** → **Datenbank**
...
2. Prüfen Sie im Task-Manager auf laufende Prozesse
...
3. Als letzte Option: Datenbank löschen und neu beginnen
::
