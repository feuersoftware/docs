...
Tippen Sie auf einen Einsatz, um die Einsatzdetails zu öffnen. Scrollen Sie nach unten, um ältere Einsätze zu laden. Die Liste aktualisiert sich **automatisch in Echtzeit** – neue Einsätze erscheinen sofort.
...
- Löschwasser-POIs und Einsatzmittel in der Umgebung
...
Über den **Aktionsbutton** (unten rechts) → **Neuer Einsatz** können Sie direkt aus dem Fahrzeug einen Einsatz anlegen:
